...
(function(){
  ...
  // Garantir scroll por touch no chat (Android WebView)
  msgs.addEventListener('touchstart', e=>e.stopPropagation(), {passive:true});
  msgs.addEventListener('touchmove',  e=>e.stopPropagation(), {passive:true});
